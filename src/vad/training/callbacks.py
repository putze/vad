...
class BestModelTracker:
    """
    Track the best epoch according to a monitored metric.
    """

    def __init__(self, mode: str = "max", min_delta: float = 0.0) -> None:
        """
    ...
    def update(self, epoch: int, value: float) -> bool:
        """
        Update the tracker with the current epoch's metric.
        ...
        Returns:
            bool: True if this is a new best epoch, else False.
        """
        if self.tracker.update(value):
